...
router = APIRouter(prefix="/api/ingestor", tags=["Data Ingestor"])

# ---------------------------------------------------------------------------
# (CORS is now configured at the main FastAPI app level)
# ---------------------------------------------------------------------------
...
@router.post("/upload/pdf", tags=["Legacy - Single Upload"])
...
@router.post("/upload/gst", tags=["Legacy - Single Upload"])
...
@router.post("/upload/bank", tags=["Legacy - Single Upload"])
...
@router.post("/analyze", tags=["Legacy - Ad-hoc Analysis"])
async def analyze(
...
@router.post("/entity-onboard", tags=["Stage 1 - Entity Onboarding"])
...
@router.post("/upload-documents/{session_id}", tags=["Stage 2 - Document Upload"])
...
@router.post("/classify-documents/{session_id}", tags=["Stage 3 - Document Classification"])
...
@router.post("/extract-data/{session_id}", tags=["Stage 4 - Extraction & Analysis"])
...
@router.get("/financial-analysis/{session_id}", tags=["Export - Downstream Integration"])
