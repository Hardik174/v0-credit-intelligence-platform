...
export default function ExtractionPage() {
  ...
  const { extraction, isLoading } = useExtraction(sessionId || undefined);
        ...
        <CardContent>
          <div className="space-y-3">
            {extraction.extractedData.map((field) => (
              <div
                key={field.id}
                className={`p-3 rounded-lg border ${field.isFlagged ? 'border-orange-200 bg-orange-50' : 'border-gray-200 bg-gray-50'
                  }`}
              >
